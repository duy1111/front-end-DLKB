...
class Header extends Component {
    ...
    render() {
        ...
        console.log('check props userInfo', this.props.userInfo);
        return (
            <div className="header-container">
                ...
                <div className="languages">
                    <span className='welcome' ><FormattedMessage id="homeHeader.welcome" />, {!!userInfo.firstName ? userInfo.firstName : ''} ! </span>
